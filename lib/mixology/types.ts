...
export type MixMaterialMeta = {
    /** Offline third-party data; only the compatibility adapter interprets supported fields. */
    compatibility?: import("./compatibility").MixCompatibility;
    id: string;
...
/** 对局消息 */
export type MixTurn = {
    compatibilityLore?: import("./compatibility-worldbook").LoreState;
    compatibilityLoreReport?: import("./compatibility-worldbook").LoreReport;
    compatibilityEdited?: boolean;
    id: string;
    role: "user" | "assistant";
